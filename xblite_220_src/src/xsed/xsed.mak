...
APP       = xsed
LIBS      =  xbl.lib xio.lib gdi32.lib user32.lib kernel32.lib comctl32.lib xsx.lib shell32.lib comdlg32.lib scilexer.lib msvcrt.lib ole32.lib combocolor.lib docksplitter.lib
OBJS      = $(APP).obj
START     = START /W
