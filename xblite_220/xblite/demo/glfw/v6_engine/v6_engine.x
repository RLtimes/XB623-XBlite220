...
FUNCTION Render()
	...
	SHARED SINGLE angle, connrodangle
	...
	IF #freelook = 1 THEN 
		glRotatef( SINGLE(mx-(#Width/0.2)), 0.0, 1.0, 0.0)			 '	Use Mouse to control
		glRotatef( SINGLE(my-(#Height/0.2)), 1.0, 0.0, 0.0)
	ELSE
		y = y + ya
		x = x + xa
		z = z + za	
