...
DECLARE FUNCTION Draw_Rectangle(SINGLE placex, SINGLE placey, SINGLE placez, SINGLE sizex, SINGLE sizey, SINGLE anglex, SINGLE angley, SINGLE anglez, SINGLE color_r, SINGLE color_g, SINGLE color_b )
...
FUNCTION Render()
	...
	IF #freelook = 1 THEN 
		glRotatef( SINGLE(mx-(#Width / 100)), 0.0, 1.0, 0)			 '	Use Mouse to control
		glRotatef( SINGLE(my-(#Height / 100)), 1.0, 0.0, 0)
	END IF

		FOR i = 20 TO 200
		
			x = (i * sin((theta+i)/10))/300
			y = (i * sin((theta+i)/20))/300
			z = (i * sin((theta+i)/30))/300
	        Draw_Rectangle(x, y, z, 0.02, 0.02, 0.0, 0.0, 0.0, 0.4,0.8,0.6)
	        
		NEXT i
                 
        Draw_Quad( 0.0, 0.0, 0.0, 0.1, 0.1, 0.1, theta, theta, theta, 0.6, 0.0, 0.2 )
...
FUNCTION Draw_Rectangle(SINGLE placex, SINGLE placey, SINGLE placez, SINGLE sizex, SINGLE sizey, SINGLE anglex, SINGLE angley, SINGLE anglez, SINGLE color_r, SINGLE color_g, SINGLE color_b )
   ...
   glPushMatrix()
      ...
      glBegin($$GL_QUADS)
         ...
         glVertex3f(-0.5*sizex+placex, 0.5*sizey+placey, placez)
         glVertex3f(0.5*sizex+placex, 0.5*sizey+placey, placez)
         glVertex3f(0.5*sizex+placex, -0.5*sizey+placey, placez)
         glVertex3f(-0.5*sizex+placex, -0.5*sizey+placey, placez)
      glEnd()
