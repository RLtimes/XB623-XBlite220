...
' custom image/graphics scrolling control.
'
PROGRAM	"canvastest"
VERSION	"0.0002"
'
...
'			SendMessageA (#hCanvas1, $$WM_CLEAR_CANVAS_IMAGE, 0, 0)			' clear bitmap
'			SendMessageA (#hCanvas1, $$WM_TOGGLE_SCROLLBARS, 0, 0)			' toggle scrollbars
			SetFocus (#hCanvas1)
...
' create main window
	title$  		= "Custom Canvas Control Demo."
